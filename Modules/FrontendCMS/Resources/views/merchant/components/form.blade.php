                    ...
                    <div class="col-xl-12">
                        <div class="primary_input mb-35">
                            ...
                            <textarea id="Maindescription" name="Maindescription"
                                class="lms_summernote summernote">{{ $content->Maindescription }}</textarea>
                    ...
                    <div class="col-xl-12">
                        <div class="primary_input mb-35">
                            ...
                            <textarea id="benifitDescription" name="benifitDescription"
                                class="lms_summernote summernote2">{{ $content->benifitDescription }}</textarea>
                    ...
                    <div class="col-xl-12">
                        <div class="primary_input mb-35">
                            ...
                            <textarea id="howitworkDescription" name="howitworkDescription"
                                class="lms_summernote summernote3">{{ $content->howitworkDescription }}</textarea>
                    ...
                    <div class="col-xl-12">
                        <div class="primary_input mb-35">
                            ...
                            <textarea id="pricingDescription" name="pricingDescription"
                                class="lms_summernote summernote4">{{ $content->pricingDescription }}</textarea>
                    ...
                    <div class="col-xl-12">
                        <div class="primary_input mb-35">
                            ...
                            <textarea id="sellerRegistrationDescription" name="sellerRegistrationDescription"
                                class="lms_summernote summernote5">{{ $content->sellerRegistrationDescription }}</textarea>
                    ...
                    <div class="col-xl-12">
                        <div class="primary_input mb-35">
                            ...
                            <textarea id="faqDescription" name="queryDescription"
                                class="lms_summernote summernote6">{{ $content->faqDescription }}</textarea>
                    ...
                    <div class="col-xl-12">
                        <div class="primary_input mb-35">
                            ...
                            <textarea id="queryDescription" name="queryDescription"
                                class="lms_summernote summernote7">{{ $content->queryDescription }}</textarea>
                            <span class="text-danger" id="error_queryDescription"></span>
                        </div>
