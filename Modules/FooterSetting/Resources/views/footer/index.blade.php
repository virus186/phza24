                            ...
                            <div class="box_header_right">
                                <div class="float-lg-right float-none pos_tab_btn justify-content-end">
                                    <ul class="nav" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link {{ $footerTab == 6?'active':'' }} show active_section_class" href="#appLinkOther" role="tab" data-toggle="tab" id="6" data-id="6"
                                                aria-selected="true">{{__('amazy.App link & others')}}</a>
                                        </li>
                                        @endif
                                        <li class="nav-item">
                                            ...
                                            <div class="white-box">
                                                <div class="add-visitor">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="primary_input mb-25">
                                                                ...
                                                                <input name="play_store" id="play_store" class="primary_input_field" placeholder="-" type="text"
                                                                       value="{{ old('play_store') ? old('play_store') : $footer_content_new->play_store}}">
                                                            ...
                                                            <div class="primary_input">
                                                                <ul id="theme_nav" class="permission_list sms_list ">
                                                                    <li>
                                                                        ...
                                                                        <p>{{ __('Play store show in frontend?') }}</p>
                                                                    </li>
                                                                </ul>
                                                            ...
                                                            <div class="primary_input">
                                                                <ul id="theme_nav" class="permission_list sms_list ">
                                                                    <li>
                                                                        ...
                                                                        <p>{{ __('App store show in frontend?') }}</p>
                                                                    </li>
                                                                </ul>
                                                            ...
                                                            <div class="primary_input">
                                                                <ul id="theme_nav" class="permission_list sms_list ">
                                                                    <li>
                                                                        ...
                                                                        <p>{{ __('Payment image show in frontend?') }}</p>
                                                                    </li>
                                                                </ul>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="primary_input mb-25">
                                                                <label class="mb-2 mr-30">{{ __('common.image') }}<small>(513 X 60)px</small></label>
