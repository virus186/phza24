    ...
    <li class="{{ $general_admin ?'mm-active' : '' }} sortable_li" data-position="{{ menuManagerCheck(1,16)->position }}" data-status="{{ menuManagerCheck(1,16)->status }}">
        ...
        <ul id="general_setting_1">
            ...
            @endif
                ...
                <li>
                    <a href="{{ route('setup.maps.index') }}" @if (request()->is('generalsetting/maps')) class="active" @endif>{{__('setup.google_maps_api')}}</a>
                </li>

                <li>
                    <a href="{{ route('setup.recaptcha.index') }}" @if (request()->is('generalsetting/recaptcha')) class="active" @endif>{{__('setup.google_recaptcha')}}</a>
                </li>
