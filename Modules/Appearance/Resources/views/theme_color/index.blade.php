                    ...
                    <form action="{{ route('appearance.themeColor.update',$themeColor->id)}}" method="POST">
                            ...
                            <div class="col-lg-12">
                                <div class="primary_input mb-25">
                                    ...
                                    <select id="color_theme" required class="primary_select mb-15"
                                        ...
                                        <option @if ($themeColor->id == $color->id ) selected @endif value="{{ $color->id }}">{{ $color->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="d-block">
                            ...
                            <div class="primary_input">
                                <button type="submit" class="primary-btn fix-gr-bg mb-2 w-100" id="save_button_parent"><i
                            ...
                            @if ($themeColor->status == 1)
                                <button class="primary-btn tr-bg" disabled href="#"
                                    dusk="Add New">{{__('common.active')}}</button>
                            @else
                                <div class="primary_input">
                                    <a href="{{route('appearance.themeColor.activate',$themeColor->id)}}"
                                        class="primary-btn fix-gr-bg w-100" id="save_button_parent"><i
                                            class="ti-check"></i>{{ __('common.inactive') }}</a>
                                </div>
                            @endif
                        </div>
                    </form>
