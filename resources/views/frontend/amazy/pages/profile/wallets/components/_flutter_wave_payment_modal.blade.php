                    ...
                    <form id="flatter_wave_form" action="{{route('my-wallet.store')}}" class="p-0" method="POST">
                        ...
                        <div class="row mb-20">
                            <div class="col-xl-6 col-md-6 mb_20">
                                ...
                                <input type="text" class="primary_input4 form-control" placeholder="{{ __('common.mobile') }}" name="phone" value="{{@old('phone')}}">
                                <span class="text-danger"></span>
                            </div>
                            <div class="col-xl-6 col-md-6 mb_20">
                        ...
                        <div class="send_query_btn d-flex justify-content-between mt-4">
                            ...
                            <button class="amaz_primary_btn style3 text-nowrap" type="submit" id="flatter_wave_submit_btn" disabled>{{ __('wallet.continue_to_recharge') }}</button>
                        </div>
                    </form>
                </section>
            </div>
