                        ...
                        <form action="#">
                            <div class="row">
                                ...
                                <div class="col-12 mb_25">
                                    ...
                                    {{-- <input name="address" id="address" placeholder="{{ __('Street Address') }}" onfocus="this.placeholder = ''" onblur="this.placeholder = '{{ __('Street Address') }}'" class="primary_input3 radius_3px style6" value="{{isset($primary_address->address_one)?$primary_address->address:''}}" type="text"> --}}
