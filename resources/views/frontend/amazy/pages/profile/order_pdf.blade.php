                                ...
                                <td>
                                   ...
                                   <table>
                                       <tbody>
                                           <tr>
                                               <td>
                                                   <h5 class="font_18 mb-0" >{{ __('shipping.shipping_info') }} @if($order->delivery_type == 'pickup_location')({{ __('shipping.collect_from_pickup_location') }}) @endif</h5>
                                               </td>
                                           </tr>
                                           <tr>
                                                <td>
                                                       ...
                                                       <tbody>
                                                           ...
                                                           <tr>
                                                                <td>
                                                                    <p class="line_grid" >
                                                                        <span>
                                                                            <span>{{__('defaultTheme.paid_by')}}</span>
                                                                            <span>:</span>
                                                                        </span>
                                                                        {{$order->GatewayName}}
                                                                    </p>
